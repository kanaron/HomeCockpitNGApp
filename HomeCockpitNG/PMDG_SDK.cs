...
namespace pmdgTests
{
    public class PMDG_SDK
    {
        ...
        public struct PMDG_NG3_Data
        {
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 7)] public byte[] IRS_DisplayLeft;                    // Left display string, zero terminated
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)] public byte[] IRS_DisplayRight;               // Right display string, zero terminated 
            public byte IRS_DisplayShowsDots;              // True if the degrees and decimal dot symbols are shown on the IRS display

            // AFS
            public byte AFS_AutothrottleServosConnected;   // True if the autothrottle system is driving the thrust levers
            public byte AFS_ControlsPitch;                 // The autoflight system is actively controlling pitch
            public byte AFS_ControlsRoll;
            ...
            public byte CVR_annunTEST;                     // CVR TEST indicator
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] FUEL_AuxFwd;                        // aux fwd A and aux fwd B
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] FUEL_AuxAft;                        //aux aft A and aux aft B
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 13)] public byte[] ELEC_MeterDisplayTop;          // Top line of the display: 3 groups of 4 digits (or symbols) + terminating zero 
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 13)] public byte[] ELEC_MeterDisplayBottom;       // Bottom line of the display
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] public byte[] ELEC_BusPowered;               // True if the corresponding bus is powered:
                                                                                                               // DC HOT BATT			0	
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] ICE_ProbeHeatSw;
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 6)] public byte[] AIR_DisplayFltAlt;              // Pressurization system FLT ALT window, zero terminated, can be blank or show dashes or show test pattern
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 6)] public byte[] AIR_DisplayLandAlt;             // Pressurization system LAND ALT window, zero terminated, can be blank or show dashes or show test pattern
            ...
            public byte MCP_indication_powered;                // true when the MCP is powered and the MCP windows are indicating
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] MAIN_annunAP;                   // Red color. See MAIN_annunAP_Amber for amber color (added to the bottom of the struct)
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] MAIN_annunAP_Amber;             // Amber color
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] MAIN_annunAT;                   // Red color. See MAIN_annunAT_Amber for amber color (added to the bottom of the struct)
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] MAIN_annunAT_Amber;             // Amber color
            ...
            public byte MAIN_annunCABIN_ALTITUDE;
            public byte MAIN_annunTAKEOFF_CONFIG;
        ...
        public struct PMDG_NGX_CDU_Screen
        {
            ...
            public byte Powered; // true if the CDU is powered
        };
        ...
        public const UInt32 MOUSE_FLAG_WHEEL_SKIP = 0x00008000;   // look at next 2 rect for mouse wheel commands
        ...
        public enum PMDGEvents : uint
        {
            ...
            EVT_EFB_R_BRIGH_UP = (EVT_EFB_L_START + 28),
